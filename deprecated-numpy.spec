...
Requires: deprecated-numpy-bin = %{version}-%{release}
Requires: deprecated-numpy-license = %{version}-%{release}
Requires: deprecated-numpy-python = %{version}-%{release}
...
%package bin
Summary: bin components for the deprecated-numpy package.
Group: Binaries
Requires: deprecated-numpy-license = %{version}-%{release}

%description bin
bin components for the deprecated-numpy package.


%package dev
Summary: dev components for the deprecated-numpy package.
Group: Development
Requires: deprecated-numpy-bin = %{version}-%{release}
Provides: deprecated-numpy-devel = %{version}-%{release}
Requires: deprecated-numpy = %{version}-%{release}

%description dev
dev components for the deprecated-numpy package.


%package extras
Summary: extras components for the deprecated-numpy package.
Group: Default

%description extras
extras components for the deprecated-numpy package.
...
%package license
Summary: license components for the deprecated-numpy package.
Group: Default

%description license
license components for the deprecated-numpy package.


%package python
Summary: python components for the deprecated-numpy package.
Group: Default

%description python
python components for the deprecated-numpy package.
...
export MAKEFLAGS=%{?_smp_mflags}
rm -rf %{buildroot}
mkdir -p %{buildroot}/usr/share/package-licenses/deprecated-numpy
cp doc/scipy-sphinx-theme/LICENSE.txt %{buildroot}/usr/share/package-licenses/deprecated-numpy/doc_scipy-sphinx-theme_LICENSE.txt
cp doc/source/license.rst %{buildroot}/usr/share/package-licenses/deprecated-numpy/doc_source_license.rst
cp doc/sphinxext/LICENSE.txt %{buildroot}/usr/share/package-licenses/deprecated-numpy/doc_sphinxext_LICENSE.txt
cp tools/npy_tempita/license.txt %{buildroot}/usr/share/package-licenses/deprecated-numpy/tools_npy_tempita_license.txt
...
/usr/share/package-licenses/deprecated-numpy/doc_scipy-sphinx-theme_LICENSE.txt
/usr/share/package-licenses/deprecated-numpy/doc_source_license.rst
/usr/share/package-licenses/deprecated-numpy/doc_sphinxext_LICENSE.txt
/usr/share/package-licenses/deprecated-numpy/tools_npy_tempita_license.txt
